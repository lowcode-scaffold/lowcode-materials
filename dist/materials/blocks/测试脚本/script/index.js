...
const { context, } = require('../../../../dist/materials/blocks/测试脚本/script/src/context');
module.exports = {
    beforeCompile: (context) => {
        const compileHandler = new main.CompileHandler3c5a281f3af548fda73cb864dd8f452b(context);
    ...
    intFromOcrText: (context) => {
        const viewCallHandler = new main.ViewCallHandler3c5a281f3af548fda73cb864dd8f452b(context);
